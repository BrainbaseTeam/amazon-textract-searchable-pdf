...
public class ConvertPDFfromS3 {
    public void run(String inBucketName, String documentName, String outBucketName,String outputDocumentName) throws IOException, InterruptedException {

        System.out.println("Generating searchable pdf from: " + inBucketName + "/" + documentName);

        //Extract text using Amazon Textract
        List<ArrayList<TextLine>> linesInPages = extractText(inBucketName, documentName);
        ...
        //Upload PDF to S3
        UploadToS3(outBucketName, outputDocumentName, "application/pdf", os.toByteArray());

        System.out.println("Generated searchable pdf: " + outBucketName + "/" + outputDocumentName);
    }
